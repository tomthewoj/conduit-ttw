...
namespace Conduit.Application.Commands.Users.Following
{
    public class UnFollowUserCommandHandler : IRequestHandler<UnFollowUserCommand, Unit>
    {
        ...
        public UnFollowUserCommandHandler(IUserRepository userRepository, IFollowingRepository folowingRepository)
        {
        ...
        public async Task<Unit> Handle(UnFollowUserCommand request, CancellationToken cancellationToken)
        {
            ...
            await _followingRepository.UnfollowUser(currentUser.Id, followeeUser.Id);
            return Unit.Value;
        }
    }
}
